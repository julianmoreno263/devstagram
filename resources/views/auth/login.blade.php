    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{route('login')}}" novalidate>
                ...
                {{-- este boton sera para recordar credenciales de usuario,  --}}
                <div class="mb-5">
                    <input type="checkbox" name="remember" id=""> <label class=" text-gray-500 text-sm" for="remember">Mantener sesión abierta</label>
                </div>
                
                <input type="submit" value="Iniciar Sesión" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 mt-3 text-white rounded-lg">
